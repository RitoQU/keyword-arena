...
INSERT INTO characters (
  ...
  '{"archetype":"giant","hat":"horn","aura":"dark","held":"shield"}'::jsonb,
  true, 1, NULL
);
...
INSERT INTO characters (
  ...
  '{"archetype":"ninja","aura":"dark","held":"dual"}'::jsonb,
  true, 2, NULL
);
...
INSERT INTO characters (
  ...
  '{"archetype":"mage","hat":"halo","aura":"holy","held":"staff"}'::jsonb,
  true, 3, NULL
);
...
INSERT INTO characters (
  ...
  '{"archetype":"beast","hat":"horn","aura":"fire"}'::jsonb,
  true, 4, NULL
);
...
INSERT INTO characters (
  ...
  '{"archetype":"elemental","hat":"halo","wings":"demon","aura":"dark"}'::jsonb,
  true, 5, NULL
);
